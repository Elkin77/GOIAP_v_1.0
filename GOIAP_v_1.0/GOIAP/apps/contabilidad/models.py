...
class Nomina(models.Model):
	...
	aux_alimentacion = models.CharField(null=True, max_length=50)
	aporte_salud = models.CharField(max_length=50)
	aporte_pension = models.CharField(max_length=50)
	retencion_fuente = models.CharField(null=True, max_length=50)
	...
	archivo = models.FileField(null=True, upload_to='contabilidad/Documentos/')
